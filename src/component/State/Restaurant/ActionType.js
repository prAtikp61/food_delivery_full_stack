...
export const UPDATE_RESUTARANT_REQUEST = "UPDATE_RESUTARANT_REQUEST";
...
export const CREATE_EVENTS_FAILURE = "UPDATE_RESTAURANT_STATUS_FAILURE";
...
export const GET_RESTAURANTS_EVENTS_REQUEST = "UPDATE_RESTAURANT_STATUS_REQUEST";
